        ...
        {lines.length === 0 ? (
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_360px]">
            ...
            <div className="h-fit border border-line p-6">
              ...
              {promo && !promoApplied && (
                <p className="mt-2 text-xs text-ash">{t.cartPromoHint}</p>
              )}
              {promoApplied && (
                <p className="mt-2 text-xs text-champagne-ink">{t.cartPromoSuccess}</p>
              )}
              ...
              <div className="mt-6 space-y-3 border-t border-line pt-6 text-sm">
                ...
                <div className="flex justify-between text-graphite">
                  ...
                  <span>{shipping === 0 ? t.cartFree : price(shipping)}</span>
                </div>
                {promoApplied && (
